...
*/var Hr,f1;(function(){var t;/** @license
 ...
 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/function e(T,y){function E(){}E.prototype=y.prototype,T.D=y.prototype,T.prototype=new E,T.prototype.constructor=T,T.C=function(v,C,N){for(var R=Array(arguments.length-2),ht=2;ht<arguments.length;ht++)R[ht-2]=arguments[ht];return y.prototype[C].apply(v,R)}}function n(){this.blockSize=-1}function r(){this.blockSize=-1,this.blockSize=64,this.g=Array(4),this.B=Array(this.blockSize),this.o=this.h=0,this.s()}e(r,n),r.prototype.s=function(){this.g[0]=1732584193,this.g[1]=4023233417,this.g[2]=2562383102,this.g[3]=271733878,this.o=this.h=0};function i(T,y,E){E||(E=0);var v=Array(16);if(typeof y=="string")for(var C=0;16>C;++C)v[C]=y.charCodeAt(E++)|y.charCodeAt(E++)<<8|y.charCodeAt(E++)<<16|y.charCodeAt(E++)<<24;else for(C=0;16>C;++C)v[C]=y[E++]|y[E++]<<8|y[E++]<<16|y[E++]<<24;y=T.g[0],E=T.g[1],C=T.g[2];var N=T.g[3],R=y+(N^E&(C^N))+v[0]+3614090360&4294967295;y=E+(R<<7&4294967295|R>>>25),R=N+(C^y&(E^C))+v[1]+3905402710&4294967295,N=y+(R<<12&4294967295|R>>>20),R=C+(E^N&(y^E))+v[2]+606105819&4294967295,C=N+(R<<17&4294967295|R>>>15),R=E+(y^C&(N^y))+v[3]+3250441966&4294967295,E=C+(R<<22&4294967295|R>>>10),R=y+(N^E&(C^N))+v[4]+4118548399&4294967295,y=E+(R<<7&4294967295|R>>>25),R=N+(C^y&(E^C))+v[5]+1200080426&4294967295,N=y+(R<<12&4294967295|R>>>20),R=C+(E^N&(y^E))+v[6]+2821735955&4294967295,C=N+(R<<17&4294967295|R>>>15),R=E+(y^C&(N^y))+v[7]+4249261313&4294967295,E=C+(R<<22&4294967295|R>>>10),R=y+(N^E&(C^N))+v[8]+1770035416&4294967295,y=E+(R<<7&4294967295|R>>>25),R=N+(C^y&(E^C))+v[9]+2336552879&4294967295,N=y+(R<<12&4294967295|R>>>20),R=C+(E^N&(y^E))+v[10]+4294925233&4294967295,C=N+(R<<17&4294967295|R>>>15),R=E+(y^C&(N^y))+v[11]+2304563134&4294967295,E=C+(R<<22&4294967295|R>>>10),R=y+(N^E&(C^N))+v[12]+1804603682&4294967295,y=E+(R<<7&4294967295|R>>>25),R=N+(C^y&(E^C))+v[13]+4254626195&4294967295,N=y+(R<<12&4294967295|R>>>20),R=C+(E^N&(y^E))+v[14]+2792965006&4294967295,C=N+(R<<17&4294967295|R>>>15),R=E+(y^C&(N^y))+v[15]+1236535329&4294967295,E=C+(R<<22&4294967295|R>>>10),R=y+(C^N&(E^C))+v[1]+4129170786&4294967295,y=E+(R<<5&4294967295|R>>>27),R=N+(E^C&(y^E))+v[6]+3225465664&4294967295,N=y+(R<<9&4294967295|R>>>23),R=C+(y^E&(N^y))+v[11]+643717713&4294967295,C=N+(R<<14&4294967295|R>>>18),R=E+(N^y&(C^N))+v[0]+3921069994&4294967295,E=C+(R<<20&4294967295|R>>>12),R=y+(C^N&(E^C))+v[5]+3593408605&4294967295,y=E+(R<<5&4294967295|R>>>27),R=N+(E^C&(y^E))+v[10]+38016083&4294967295,N=y+(R<<9&4294967295|R>>>23),R=C+(y^E&(N^y))+v[15]+3634488961&4294967295,C=N+(R<<14&4294967295|R>>>18),R=E+(N^y&(C^N))+v[4]+3889429448&4294967295,E=C+(R<<20&4294967295|R>>>12),R=y+(C^N&(E^C))+v[9]+568446438&4294967295,y=E+(R<<5&4294967295|R>>>27),R=N+(E^C&(y^E))+v[14]+3275163606&4294967295,N=y+(R<<9&4294967295|R>>>23),R=C+(y^E
+v[4]+4149444226&4294967295,y=E+(R<<6&4294967295|R>>>26),R=N+(E^(y|~C))+v[11]+3174756917&4294967295,N=y+(R<<10&4294967295|R>>>22),R=C+(y^(N|~E))+v[2]+718787259&4294967295,C=N+(R<<15&4294967295|R>>>17),R=E+(N^(C|~y))+v[9]+3951481745&4294967295,T.g[0]=T.g[0]+y&4294967295,T.g[1]=T.g[1]+(C+(R<<21&4294967295|R>>>11))&4294967295,T.g[2]=T.g[2]+C&4294967295,T.g[3]=T.g[3]+N&4294967295}r.prototype.u=function(T,y){y===void 0&&(y=T.length);for(var E=y-this.blockSize,v=this.B,C=this.h,N=0;N<y;){if(C==0)for(;N<=E;)i(this,T,N),N+=this.blockSize;if(typeof T=="string"){for(;N<y;)if(v[C++]=T.charCodeAt(N++),C==this.blockSize){i(this,v),C=0;break}}else for(;N<y;)if(v[C++]=T[N++],C==this.blockSize){i(this,v),C=0;break}}this.h=C,this.o+=y},r.prototype.v=function(){var T=Array((56>this.h?this.blockSize:2*this.blockSize)-this.h);T[0]=128;for(var y=1;y<T.length-8;++y)T[y]=0;var E=8*this.o;for(y=T.length-8;y<T.length;++y)T[y]=E&255,E/=256;for(this.u(T),T=Array(16),y=E=0;4>y;++y)for(var v=0;32>v;v+=8)T[E++]=this.g[y]>>>v&255;return T};function s(T,y){var E=l;return Object.prototype.hasOwnProperty.call(E,T)?E[T]:E[T]=y(T)}function o(T,y){this.h=y;for(var E=[],v=!0,C=T.length-1;0<=C;C--){var N=T[C]|0;v&&N==y||(E[C]=N,v=!1)}this.g=E}var l={};function u(T){return-128<=T&&128>T?s(T,function(y){return new o([y|0],0>y?-1:0)}):new o([T|0],0>T?-1:0)}function c(T){if(isNaN(T)||!isFinite(T))return p;if(0>T)return x(c(-T));for(var y=[],E=1,v=0;T>=E;v++)y[v]=T/E|0,E*=4294967296;return new o(y,0)}function d(T,y){if(T.length==0)throw Error("number format error: empty string");if(y=y||10,2>y||36<y)throw Error("radix out of range: "+y);if(T.charAt(0)=="-")return x(d(T.substring(1),y));if(0<=T.indexOf("-"))throw Error('number format error: interior "-" character');for(var E=c(Math.pow(y,8)),v=p,C=0;C<T.length;C+=8){var N=Math.min(8,T.length-C),R=parseInt(T.substring(C,C+N),y);8>N?(N=c(Math.pow(y,N)),v=v.j(N).add(c(R))):(v=v.j(E),v=v.add(c(R)))}return v}var p=u(0),m=u(1),S=u(16777216);t=o.prototype,t.m=function(){if(k(this))return-x(this).m();for(var T=0,y=1,E=0;E<this.g.length;E++){var v=this.i(E);T+=(0<=v?v:4294967296+v)*y,y*=4294967296}return T},t.toString=function(T){if(T=T||10,2>T||36<T)throw Error("radix out of range: "+T);if(P(this))return"0";if(k(this))return"-"+x(this).toString(T);for(var y=c(Math.pow(T,6)),E=this,v="";;){var C=O(E,y).g;E=w(E,C.j(y));var N=((0<E.g.length?E.g[0]:E.h)>>>0).toString(T);if(E=C,P(E))return N+v;for(;6>N.length;)N="0"+N;v=N+v}},t.i=function(T){return 0>T?0:T<this.g.length?this.g[T]:this.h};function P(T){if(T.h!=0)return!1;for(var y=0;y<T.g.length;y++)if(T.g[y]!=0)return!1;return!0}function k(T){return T.h==-1}t.l=function(T){return T=w(this,T),k(T)?-1:P(T)?0:1};function x(T){for(var y=T.g.length,E=[],v=0;v<y;v++)E[v]=~T.g[v];return new o(E,~T.h).add(m)}t.abs=function(){return k(this)?x(this):this},t.add=function(T){for(var y=Math.max(this.g.length,T.g.length),E=[],v=0,C=0;C<=y;C++){var N=v+(this.i(C)&65535)+(T.i(C)&65535),R=(N>>>16)+(this.i(C)>>>16)+(T.i(C)>>>16);v=R>>>16,N&=65535,R&=65535,E[C]=R<<16|N}return new o(E,E[E.length-1]&-2147483648?-1:0)};function w(T,y){return T.add(x(y))}t.j=function(T){if(P(this)||P(T))return p;if(k(this))return k(T)?x(this).j(x(T)):x(x(this).j(T));if(k(T))return x(this.j(x(T)));if(0>this.l(S)&&0>T.l(S))return c(this.m()*T.m());for(var y=this.g.length+T.g.length,E=[],v=0;v<2*y;v++)E[v]=0;for(v=0;v<this.g.length;v++)for(var C=0;C<T.g.length;C++){var N=this.i(v)>>>16,R=this.i(v)&65535,ht=T.i(C)>>>16,Cr=T.i(C)&65535;E[2*v+2*C]+=R*Cr,_(E,2*v+2*C),E[2*v+2*C+1]+=N*Cr,_(E,2*v+2*C+1),E[2*v+2*C+1]+=R*ht,_(E,2*v+2*C+1),E[2*v+2*C+2]+=N*ht,_(E,2*v+2*C+2)}for(v=0;v<y;v++)E[v]=E[2*v+1]<<16|E[2*v];for(v=y;v<2*y;v++)E[v]=0;return new o(E,0)};function _(T,y){for(;(T[y]&65535)!=T[y];)T[y+1]+=T[y]>>>16,T[y]&=65535,y++}function I(T,y){this.g=T,this.h=y}function O(T,y){if(P(y))throw Error("division by zero");if(P(T))return new I(p,p);if(k(T))return y=O(x(T),y),new I(x(y.g),x(y.h));if(k(y))return y=O(T,x(y)),new I(x(y.g),y.h);if(30<T.g.length){if(k(T)||k(y))throw Error("slowDivide_ only works with positive integers.");for(var E=m,v=y;0>=v.l(T);)E=V(E),v=V(v);var C=F(E,1),N=F(v,1);for(v=F(v,2),E=F(E,2);!P(v);){var R=N.add(v);0>=R.l(T)&&(C=C.add(E),N=R),v=F(v,1),E=F(E,1)}return y=w(T,C.j(y)),new I(C,y)}for(C=p;0<=T.l(y);){for(E=Math.max(1,Math.floor(T.m()/y.m())),v=Math.ceil(Math.log(E)/Math.LN2),v=48>=v?1:Math.pow(2,v-48),N=c(E),R=N.j(y);k(R)||0<R.l(T);)E-=v,N=c(E),R=N.j(y);P(N)&&(N=m),C=C.add(N),T=w(T,R)}return new I(C,T)}t.A=function(T){return O(this,T).h},t.and=function(T){for(var y=Math.max(this.g.length,T.g.length),E=[],v=0;v<y;v++)E[v]=this.i(v)&T.i(v);return new o(E,this.h&T.h)},t.or=function(T){for(var y=Math.max(this.g.length,T.g.length),E=[],v=0;v<y;v++)E[v]=this.i(v)|T.i(v);return new o(E,this.h|T.h)},t.xor=function(T){for(var y=Math.max(this.g.length,T.g.length),E=[],v=0;v<y;v++)E[v]=this.i(v)^T.i(v);return new o(E,this.h^T.h)};function V(T){for(var y=T.g.length+1,E=[],v=0;v<y;v++)E[v]=T.i(v)<<1|T.i(v-1)>>>31;return new o(E,T.h)}function F(T,y){var E=y>>5;y%=32;for(var v=T.g.length-E,C=[],N=0;N<v;N++)C[N]=0<y?T.i(N+E)>>>y|T.i(N+E+1)<<32-y:T.i(N+E);return new o(C,T.h)}r.prototype.digest=r.prototype.v,r.prototype.reset=r.prototype.s,r.prototype.update=r.prototype.u,f1=r,o.prototype.add=o.prototype.add,o.prototype.multiply=o.prototype.j,o.prototype.modulo=o.prototype.A,o.prototype.compare=o.prototype.l,o.prototype.toNumber=o.prototype.m,o.prototype.toString=o.prototype.toString,o.prototype.getBits=o.prototype.i,o.fromNumber=c,o.fromString=d,Hr=o}).apply(typeof ry<"u"?ry:typeof self<"u"?self:typeof window<"u"?window:{});var Wa=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
Copyright The Closure Library Authors.
SPDX-License-Identifier: Apache-2.0
